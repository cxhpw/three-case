...
Command: npx gltfjsx@6.1.4 .\\public\\butterfly\\scene.gltf -T
...
export function Model(props: any) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("src/models/scene-transformed.glb");
...
useGLTF.preload("src/models/scene-transformed.glb");
